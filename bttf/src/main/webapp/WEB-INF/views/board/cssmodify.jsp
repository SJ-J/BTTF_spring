                        ...
                        <div class="my_box" data-height="height">
							...
							<form name = "cssmodify" action="${pageContext.request.contextPath }/board/cssmodify" method="post">
								...
								<div class="col-auto">
									...
									<input id="subject" name="post_subject" class="form-control margin-b-50" type="text" placeholder="제목" value="${cssview.post_subject }">
                        	...
                        	<a class="btn btn-primary mt-4" id="list" onclick="confirm_backlist_css()">목록</a>
                            </form>
                        </div>
                    </div>
                </div>
