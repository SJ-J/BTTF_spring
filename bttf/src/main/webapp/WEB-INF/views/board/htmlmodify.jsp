   ...
   <c:set var="board" value="${requestScope.board }"/>
                ...
                <div class="col-sm-12 sm-margin-b-2" style="margin-bottom: 20px;">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                        <div class="my_box" data-height="height">
                            <!-- Start write Form -->
							<form name = "htmlmodify" action="${pageContext.request.contextPath }/board/htmlmodify" method="post">
								<input type="hidden" name="post_id" value="${htmlview.post_id }">
								<div class="col-auto">
									<label for="subject">제목</label>
									<input id="subject" name="post_subject" class="form-control margin-b-50" type="text" placeholder="제목" value="${htmlview.post_subject }">
	...
	<script>
    	...
    	function updateReply( post_id ){
    		if (true){
    			document.edit.action = "${pageContext.request.contextPath}/pages/htmlBoardView.js?post_id=" +  post_id;
